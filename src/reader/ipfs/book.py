...
DEFAULT_KUBO = gateway.DEFAULT_KUBO
...
def open_by_cid(
    ...
    info = gateway.probe(cid, gateways=gateways, kubo=kubo)
    ...
    manifest = gateway.fetch_manifest(cid, gateways=gateways, kubo=kubo)
    ...
    def fetch_blob(blob_cid: str) -> bytes:
        ...
        return gateway.fetch_blob(blob_cid, gateways=gateways, kubo=kubo)
